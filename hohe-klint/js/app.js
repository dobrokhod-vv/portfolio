        ...
        document.addEventListener("DOMContentLoaded", (() => {
            ...
            function handleScroll() {
                if (window.innerWidth > 991) {
                    const rotateDeg = window.scrollY / 5 % 360;
                    plate.style.transform = `rotate(${rotateDeg}deg)`;
                    plate.style.transition = "transform 0.3s ease-out";
                } else plate.style.transform = "";
            }
